...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("30/10/2023"), "Partiu viagem", "Vou viajar para Dubai. Abraços!", maria);
		Post post2 = new Post(null, sdf.parse("31/10/2023"), "Bom dia", "Acordei feliz hoje", maria);
